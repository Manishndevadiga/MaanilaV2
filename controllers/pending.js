...
module.exports = {
  ...
  pending_post: async (req, res) => {
    ...
    function getUserNamesAndeligibilityOn(peopleDetails) {
      const userNames = peopleDetails.map((user) => ({
        name: user.name,
        eligibilityOn: new Date(user.eligibilityOn).getFullYear(),
      }));
      return userNames;
    }

    const peopleDetails = await Peoples.find({ eligible: "true" });
    const userNames = getUserNamesAndeligibilityOn(peopleDetails);
    console.log(
      "..............................................................."
    );
    ...
    // userNames looks like this.....
    // [
    //   { name: 'user1', eligibilityOn: 2024 },
    //   { name: 'user2', eligibilityOn: 2024 }
    // ]
    //////////////////////////////////////////////////////////////////////////////////////

    const calculateNetPayments = (user, year, userNames) => {
      if (userNames.some((item) => item.name === user.name)) {
